...
- Настройки данной программы можно увидеть на изображении. После этого выберите драйвер и удалите его.

![Настройки DDU](https://i.imgur.com/E7ZH1ww.png). 
...
- Если вам нужен GeForce Experience, скачайте его после установки видеодрайвера. В другом окне ставьте строго эти галки, никаких других, так как в разделе `Show Expert Tweaks` пункт `Disable Driver Telemetry` может вызвать недействительность сертификата, в результате чего драйвер не установится на 24h2.

![Галочки NVCleanstall](https://i.imgur.com/3yXMkB4.png).

- После установки нажмите сюда:

![Удаление папки GFExperience](https://i.imgur.com/G9vjQjU.png)
...
## 3. Strip вашего драйвера NVIDIA
