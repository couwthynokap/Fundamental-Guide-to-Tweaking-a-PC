...
1. **Скачивание и запуск NVCleanstall**: 
   Сначала скачайте NVCleanstall по следующей ссылке: [Скачать NVCleanstall](https://www.techpowerup.com/download/techpowerup-nvcleanstall/). Запустите программу после завершения загрузки.

2. **Выбор версии драйвера**: 
...
3. **Обратите внимание на новые драйверы**: 
